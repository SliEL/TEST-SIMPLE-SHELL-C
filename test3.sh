...
# Execute the student's shell and save the output
echo "$shell_input" | ./shell > OUTPUTFILE 2> ERROR_OUTPUTFILE

# Execute /bin/sh and save the output
echo "$shell_input" | /bin/sh > EXPECTED_OUTPUTFILE 2> EXPECTED_ERROR_OUTPUTFILE

# Compare the student's shell output with /bin/sh output
diff
